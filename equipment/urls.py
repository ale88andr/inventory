...
from equipment.views import EquipmentsView, EquipmentTypesView, DetailTypeView, EquipmentLocationsView, DetailLocationView, EquipmentChown
...
urlpatterns = (
    ...
    url(r'(?P<pk>\d+)/chown/$', EquipmentChown.as_view(), name='equipment_chown')
)
